...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'local' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-09-04 21:52:44',
                'modified' => '2019-09-04 21:52:44'
            ],
        ];
        parent::init();
    }
